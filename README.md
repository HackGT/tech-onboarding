...
- [ ] `UserData.tsx` Add a button that allows you to sort the users by their first name **doesn't work for some reason**
- [x] `UserCard.tsx` Create a modal that shows the user's full name, email, and phone number when you click on the user card **completed without creating new UserModal component**
